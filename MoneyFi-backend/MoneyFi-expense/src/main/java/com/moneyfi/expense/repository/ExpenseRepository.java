...
public interface ExpenseRepository extends JpaRepository<ExpenseModel, Long> {
    ...
    public ExpenseModel findByUserIdAndCatergory(Long userId, String category);
    ...
    @Query("SELECT MONTH(e.date) AS month, SUM(e.amount) AS total " +
            ...
            "ORDER BY month ASC")
    public List<Object[]> findMonthlyExpenses(Long userId, int year, boolean deleteStatus);
