...
public class BatchScheduler {
    ...
    public void runMonthlyBatchJob() throws Exception {
        triggerBatchJob.triggerBatchJob(TransactionServiceType.INCOME, null, null);
        triggerBatchJob.triggerBatchJob(TransactionServiceType.EXPENSE, null, null);
    }

    @Scheduled(cron = "0 0 0 * * *")
    public void runDailyBatchJob() throws Exception {
        triggerBatchJob.triggerBatchJob(TransactionServiceType.GOAL, null, null);
    }
}
