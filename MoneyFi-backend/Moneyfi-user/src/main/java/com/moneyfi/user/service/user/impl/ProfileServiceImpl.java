...
import com.moneyfi.user.model.general.ExcelTemplate;
import com.moneyfi.user.model.general.ProfileModel;
import com.moneyfi.constants.enums.NotificationQueueEnum;
import com.moneyfi.user.repository.general.ContactUsHistRepository;
import com.moneyfi.user.repository.general.ContactUsRepository;
import com.moneyfi.user.repository.general.ExcelTemplateRepository;
...
import com.moneyfi.user.service.user.dto.emaildto.UserRaisedDefectDto;
...
public class ProfileServiceImpl implements ProfileService {
    ...
    public ProfileDetailsDto saveUserDetails(String username, Long userId, ProfileModel profile) {
        ...
        return convertProfileModelToProfileDetailsDto(profileRepository.save(fetchProfile), username);
    }
    ...
    private ProfileDetailsDto convertProfileModelToProfileDetailsDto(ProfileModel savedProfile, String username) {
        ...
        profileDetailsDto.setEmail(username);
        return profileDetailsDto;
    }
}
