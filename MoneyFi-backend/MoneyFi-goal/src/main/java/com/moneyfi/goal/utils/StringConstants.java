...
public class StringConstants {
    ...
    public static final String SAVE_EXPENSE_EXPENSE_URL = "http://MONEYFI-EXPENSE/api/v1/expense/saveExpense";
    public static final String DELETE_EXPENSE_EXPENSE_URL = "http://MONEYFI-EXPENSE/api/v1/expense";
